...
public class CustomListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		mContext = context;
		View moreView = (View)LayoutInflater.from(mContext).inflate(R.layout.layout_footerview, null);
		addView(moreView);
		moreView.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
		
		mContentView = moreView.findViewById(R.id.footerView);
		mProgressBar = moreView.findViewById(R.id.progress);
		mHintView = (TextView)moreView.findViewById(R.id.footerTv);
	}
}
