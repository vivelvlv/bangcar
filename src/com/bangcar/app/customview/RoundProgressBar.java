...
public class RoundProgressBar extends View {
	...
	/** 设置剩余多少天 */
	public synchronized void setDays(int leftDays, int allDays) {
		this.leftDays = leftDays;
		this.allDays = allDays;

		setMax(allDays);
		setProgress(allDays - leftDays);
...
//		paint.setTypeface(Typeface); // 设置字体
		...
		float textWidth = paint.measureText("剩" + leftDays + "天"); // 测量字体宽度，我们需要根据字体的宽度设置在圆环中间

		if (textIsDisplayable && percent != 0 && style == STROKE) {
			canvas.drawText("剩" + leftDays + "天", centre - textWidth / 2,
