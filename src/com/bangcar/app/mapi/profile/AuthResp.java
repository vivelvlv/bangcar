...
public class AuthResp implements org.apache.thrift.TBase<AuthResp, AuthResp._Fields>, java.io.Serializable, Cloneable, Comparable<AuthResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AuthResp");
  ...
  static {
    schemes.put(StandardScheme.class, new AuthRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AuthRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AuthResp.class, metaDataMap);
  }
   ...
   */
  public AuthResp(AuthResp other) {
    if (other.isSetHead()) {
  ...
  public AuthResp setHead(com.bangcar.app.mapi.base.MApiRespHead head) {
    this.head = head;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AuthResp)
      return this.equals((AuthResp)that);
    return false;
  }

  public boolean equals(AuthResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AuthResp other) {
  ...
  private static class AuthRespStandardSchemeFactory implements SchemeFactory {
    public AuthRespStandardScheme getScheme() {
      return new AuthRespStandardScheme();
    }
  }

  private static class AuthRespStandardScheme extends StandardScheme<AuthResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AuthResp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AuthResp struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AuthRespTupleSchemeFactory implements SchemeFactory {
    public AuthRespTupleScheme getScheme() {
      return new AuthRespTupleScheme();
    }
  }

  private static class AuthRespTupleScheme extends TupleScheme<AuthResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AuthResp struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AuthResp struct) throws org.apache.thrift.TException {
