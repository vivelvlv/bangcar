...
public class FindTransPwdResp implements org.apache.thrift.TBase<FindTransPwdResp, FindTransPwdResp._Fields>, java.io.Serializable, Cloneable, Comparable<FindTransPwdResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FindTransPwdResp");
  ...
  static {
    schemes.put(StandardScheme.class, new FindTransPwdRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FindTransPwdRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FindTransPwdResp.class, metaDataMap);
  }

  public FindTransPwdResp() {
  }
   ...
   */
  public FindTransPwdResp(FindTransPwdResp other) {
    if (other.isSetHead()) {
  ...
  public FindTransPwdResp deepCopy() {
    return new FindTransPwdResp(this);
  }
  ...
  public FindTransPwdResp setHead(com.bangcar.app.mapi.base.MApiRespHead head) {
    this.head = head;
    return this;
  }
   ...
   * 重置交易密码的凭据
   */
  public FindTransPwdResp setAuthCode(String authCode) {
    this.authCode = authCode;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FindTransPwdResp)
      return this.equals((FindTransPwdResp)that);
    return false;
  }

  public boolean equals(FindTransPwdResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FindTransPwdResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FindTransPwdResp(");
    boolean first = true;
  ...
  private static class FindTransPwdRespStandardSchemeFactory implements SchemeFactory {
    public FindTransPwdRespStandardScheme getScheme() {
      return new FindTransPwdRespStandardScheme();
    }
  }

  private static class FindTransPwdRespStandardScheme extends StandardScheme<FindTransPwdResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FindTransPwdResp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindTransPwdResp struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FindTransPwdRespTupleSchemeFactory implements SchemeFactory {
    public FindTransPwdRespTupleScheme getScheme() {
      return new FindTransPwdRespTupleScheme();
    }
  }

  private static class FindTransPwdRespTupleScheme extends TupleScheme<FindTransPwdResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FindTransPwdResp struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FindTransPwdResp struct) throws org.apache.thrift.TException {
