...
public class ResetTransPwdReq implements org.apache.thrift.TBase<ResetTransPwdReq, ResetTransPwdReq._Fields>, java.io.Serializable, Cloneable, Comparable<ResetTransPwdReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ResetTransPwdReq");
  ...
  static {
    schemes.put(StandardScheme.class, new ResetTransPwdReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ResetTransPwdReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ResetTransPwdReq.class, metaDataMap);
  }

  public ResetTransPwdReq() {
  }
   ...
   */
  public ResetTransPwdReq(ResetTransPwdReq other) {
    if (other.isSetHead()) {
  ...
  public ResetTransPwdReq deepCopy() {
    return new ResetTransPwdReq(this);
  }
  ...
  public ResetTransPwdReq setHead(com.bangcar.app.mapi.base.MApiReqHead head) {
    this.head = head;
    return this;
  }
   ...
   * 重置交易密码的凭据
   */
  public ResetTransPwdReq setAuthCode(String authCode) {
    this.authCode = authCode;
    return this;
  }
   ...
   * 身份证号码
   */
  public ResetTransPwdReq setIdcard(String idcard) {
    this.idcard = idcard;
    return this;
  }
   ...
   * 新交易密码
   */
  public ResetTransPwdReq setNewPassword(String newPassword) {
    this.newPassword = newPassword;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ResetTransPwdReq)
      return this.equals((ResetTransPwdReq)that);
    return false;
  }

  public boolean equals(ResetTransPwdReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ResetTransPwdReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ResetTransPwdReq(");
    boolean first = true;
  ...
  private static class ResetTransPwdReqStandardSchemeFactory implements SchemeFactory {
    public ResetTransPwdReqStandardScheme getScheme() {
      return new ResetTransPwdReqStandardScheme();
    }
  }

  private static class ResetTransPwdReqStandardScheme extends StandardScheme<ResetTransPwdReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ResetTransPwdReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResetTransPwdReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ResetTransPwdReqTupleSchemeFactory implements SchemeFactory {
    public ResetTransPwdReqTupleScheme getScheme() {
      return new ResetTransPwdReqTupleScheme();
    }
  }

  private static class ResetTransPwdReqTupleScheme extends TupleScheme<ResetTransPwdReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ResetTransPwdReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ResetTransPwdReq struct) throws org.apache.thrift.TException {
