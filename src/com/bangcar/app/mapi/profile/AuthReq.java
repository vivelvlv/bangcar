...
public class AuthReq implements org.apache.thrift.TBase<AuthReq, AuthReq._Fields>, java.io.Serializable, Cloneable, Comparable<AuthReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AuthReq");
  ...
  static {
    schemes.put(StandardScheme.class, new AuthReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AuthReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AuthReq.class, metaDataMap);
  }
  ...
  public AuthReq setHead(com.bangcar.app.mapi.base.MApiReqHead head) {
    this.head = head;
    return this;
  }
   ...
   * 真实姓名
   */
  public AuthReq setName(String name) {
    this.name = name;
    return this;
  }
   ...
   * 身份证号
   */
  public AuthReq setIdcard(String idcard) {
    this.idcard = idcard;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AuthReq)
      return this.equals((AuthReq)that);
    return false;
  }

  public boolean equals(AuthReq that) {
    if (that == null)
      return false;
  ...
  private static class AuthReqStandardScheme extends StandardScheme<AuthReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AuthReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AuthReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AuthReqTupleScheme extends TupleScheme<AuthReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AuthReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AuthReq struct) throws org.apache.thrift.TException {
