...
public class SignUpResp implements org.apache.thrift.TBase<SignUpResp, SignUpResp._Fields>, java.io.Serializable, Cloneable, Comparable<SignUpResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SignUpResp");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SignUpResp.class, metaDataMap);
  }
   ...
   */
  public SignUpResp(SignUpResp other) {
    if (other.isSetHead()) {
  ...
  public SignUpResp setHead(com.bangcar.app.mapi.base.MApiRespHead head) {
    this.head = head;
    return this;
  }
   ...
   * 用户信息
   */
  public SignUpResp setUser(com.bangcar.app.mapi.common.User user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SignUpResp)
      return this.equals((SignUpResp)that);
    return false;
  }

  public boolean equals(SignUpResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SignUpResp other) {
  ...
  private static class SignUpRespStandardScheme extends StandardScheme<SignUpResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SignUpResp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SignUpResp struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SignUpRespTupleScheme extends TupleScheme<SignUpResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SignUpResp struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SignUpResp struct) throws org.apache.thrift.TException {
