...
public class SignOutReq implements org.apache.thrift.TBase<SignOutReq, SignOutReq._Fields>, java.io.Serializable, Cloneable, Comparable<SignOutReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SignOutReq");
  ...
  static {
    schemes.put(StandardScheme.class, new SignOutReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SignOutReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SignOutReq.class, metaDataMap);
  }
   ...
   */
  public SignOutReq(SignOutReq other) {
    if (other.isSetHead()) {
  ...
  public SignOutReq setHead(com.bangcar.app.mapi.base.MApiReqHead head) {
    this.head = head;
    return this;
  }
  ...
  public SignOutReq setDeviceToken(String deviceToken) {
    this.deviceToken = deviceToken;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SignOutReq)
      return this.equals((SignOutReq)that);
    return false;
  }

  public boolean equals(SignOutReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SignOutReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SignOutReq(");
    boolean first = true;
  ...
  private static class SignOutReqStandardSchemeFactory implements SchemeFactory {
    public SignOutReqStandardScheme getScheme() {
      return new SignOutReqStandardScheme();
    }
  }

  private static class SignOutReqStandardScheme extends StandardScheme<SignOutReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SignOutReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SignOutReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SignOutReqTupleSchemeFactory implements SchemeFactory {
    public SignOutReqTupleScheme getScheme() {
      return new SignOutReqTupleScheme();
    }
  }

  private static class SignOutReqTupleScheme extends TupleScheme<SignOutReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SignOutReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SignOutReq struct) throws org.apache.thrift.TException {
