...
public class TYgbTransport extends TTransport {
	...
	protected static final String key = "android1.0";
	...
	public static class Factory extends TTransportFactory {
		...
		public Factory() {
			maxLength_ = TYgbTransport.DEFAULT_MAX_LENGTH;
		}
		...
		public TTransport getTransport(TTransport base) {
			return new TYgbTransport(base, maxLength_);
		}
	}
	 ...
	 */
	public TYgbTransport(TTransport transport, int maxLength) {
		transport_ = transport;
		maxLength_ = maxLength;
	}

	public TYgbTransport(TTransport transport) {
		transport_ = transport;
		maxLength_ = TYgbTransport.DEFAULT_MAX_LENGTH;
	}
	...
	public void flush() throws TTransportException {
		...
		int len = 0;
		try {
			//String text = new String(Base64.encode(buf, Base64.DEFAULT), "utf8");
			String rst = Cipher.encrypt(key, buf);
			buf = rst.getBytes("utf8");
			len = buf.length;
			writeBuffer_.reset();
		} catch (UnsupportedEncodingException e) {
